...
var num = 13;
console.log("Quero te contar, meu número da sorte é " + num);

num = 7;
num2 = 22;
console.log("Não, espera, é " + num, "Ah, esse era o da mamãe. O meu é " + num2);

num = 20;
console.log("Já decidi: é " + num, "Bingo!");